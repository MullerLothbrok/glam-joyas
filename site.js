(() => {
  ...
  document.querySelectorAll('[data-whatsapp]').forEach(element => {element.href = 'https://wa.me/' + window.GLAM_CONFIG.whatsapp + (element.dataset.message ? '?text=' + encodeURIComponent(element.dataset.message) : '');});
})();
